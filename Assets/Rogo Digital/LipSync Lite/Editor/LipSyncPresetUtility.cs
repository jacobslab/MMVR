...
#pragma warning disable 618
	[MenuItem("Window/Rogo Digital/LipSync Lite/Convert LipSync Preset")]
	public static void ConvertPreset () {
		...
		foreach (Object preset in selection) {
			...
			newPreset.CreateFromShapes(oldPreset.phonemeShapes.ToArray(), null);
	...
	[MenuItem("Window/Rogo Digital/LipSync Lite/Convert LipSync Preset", true)]
