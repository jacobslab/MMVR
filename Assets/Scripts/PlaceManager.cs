...
public class PlaceManager : MonoBehaviour {
	...
	{
		SpawnableObject newObj = new SpawnableObject ("cube", Camera.main.transform.position + Camera.main.transform.forward * 10f,SpawnableObject.ObjectType.Cube);
	...
	public void CreateCharacter()
	{
		...
		SpawnableObject newObj = new SpawnableObject ("character", Camera.main.transform.position + Camera.main.transform.forward * 10f,SpawnableObject.ObjectType.Character);
